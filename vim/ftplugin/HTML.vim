...
" Further Modifications: David W.H. Swenson. Re-released as GPL. For further
" information on changes, see file "dwhsdiffs.txt" Copyrights for those
" changes to David W.H. Swenson, 2004.
"
...
"
" [dwhs note: Please verify the command that led to your email before sending
" something to Christian Robinson. If your email is about my additions or
" modifications, then you should contact me about them.]
"
...
function! s:HTMLconvertCase(str)
  ...
  elseif g:html_tag_case =~? 'l\(ower\(case\)\?\)\?'
    ...
    echohl WarningMsg
    echomsg "g:html_tag_case = '" . g:html_tag_case . "' invalid, overriding to 'lowercase'."
    echohl None
...
call HTMLmap("inoremap", "À", "&Agrave;")
call HTMLmap("inoremap", "&A'", "&Aacute;")
call HTMLmap("inoremap", "Á", "&Aacute;")
call HTMLmap("inoremap", "&A^", "&Acirc;")
call HTMLmap("inoremap", "Â", "&Acirc;")
call HTMLmap("inoremap", "&A~", "&Atilde;")
" is there a Mac &Atilde; equivalent?
call HTMLmap("inoremap", "&A\"", "&Auml;")
call HTMLmap("inoremap", "Ä", "&Auml;")
call HTMLmap("inoremap", "&Ao", "&Aring;")
call HTMLmap("inoremap", "Å", "&Aring;")
call HTMLmap("inoremap", "&AE", "&AElig;")
" aelig Mac version
call HTMLmap("inoremap", "&C,", "&Ccedil;")
call HTMLmap("inoremap", "Ç", "&Ccedil;")
call HTMLmap("inoremap", "&E`", "&Egrave;")
call HTMLmap("inoremap", "È", "&Egrave;")
call HTMLmap("inoremap", "&E'", "&Eacute;")
call HTMLmap("inoremap", "É", "&Eacute;")
call HTMLmap("inoremap", "&E^", "&Ecirc;")
call HTMLmap("inoremap", "Ê", "&Ecirc;")
call HTMLmap("inoremap", "&E\"", "&Euml;")
call HTMLmap("inoremap", "Ë", "&Euml;")
call HTMLmap("inoremap", "&I`", "&Igrave;")
call HTMLmap("inoremap", "Ì", "&Igrave;")
call HTMLmap("inoremap", "&I'", "&Iacute;")
call HTMLmap("inoremap", "Í", "&Iacute;")
call HTMLmap("inoremap", "&I^", "&Icirc;")
call HTMLmap("inoremap", "Î", "&Icirc;")
call HTMLmap("inoremap", "&I\"", "&Iuml;")
call HTMLmap("inoremap", "Ï", "&Iuml;")
call HTMLmap("inoremap", "&N~", "&Ntilde;")
call HTMLmap("inoremap", "Ñ", "&Ntilde;")
call HTMLmap("inoremap", "&O`", "&Ograve;")
call HTMLmap("inoremap", "Ò", "&Ograve;")
call HTMLmap("inoremap", "&O'", "&Oacute;")
call HTMLmap("inoremap", "Ó", "&Oacute;")
call HTMLmap("inoremap", "&O^", "&Ocirc;")
call HTMLmap("inoremap", "Ô", "&Ocirc;")
call HTMLmap("inoremap", "&O~", "&Otilde;")
call HTMLmap("inoremap", "Õ", "&Otilde;")
call HTMLmap("inoremap", "&O\"", "&Ouml;")
call HTMLmap("inoremap", "Ö", "&Ouml;")
call HTMLmap("inoremap", "&O/", "&Oslash;")
call HTMLmap("inoremap", "Ø", "&Oslash;")
call HTMLmap("inoremap", "&U`", "&Ugrave;")
call HTMLmap("inoremap", "Ù", "&Ugrave;")
call HTMLmap("inoremap", "&U'", "&Uacute;")
call HTMLmap("inoremap", "Ú", "&Uacute;")
call HTMLmap("inoremap", "&U^", "&Ucirc;")
call HTMLmap("inoremap", "&U\"", "&Uuml;")
call HTMLmap("inoremap", "Ü", "&Uuml;")
call HTMLmap("inoremap", "&Y'", "&Yacute;")
" don't think this exists normally as a Mac character
call HTMLmap("inoremap", "&a`", "&agrave;")
call HTMLmap("inoremap", "à", "&agrave;")
call HTMLmap("inoremap", "&a'", "&aacute;")
call HTMLmap("inoremap", "á", "&aacute;")
call HTMLmap("inoremap", "&a^", "&acirc;")
call HTMLmap("inoremap", "â", "&acirc;")
call HTMLmap("inoremap", "&a~", "&atilde;")
call HTMLmap("inoremap", "ã", "&atilde;")
call HTMLmap("inoremap", "&a\"", "&auml;")
call HTMLmap("inoremap", "ä", "&auml;")
call HTMLmap("inoremap", "&ao", "&aring;")
call HTMLmap("inoremap", "å", "&aring;")
call HTMLmap("inoremap", "&ae", "&aelig;")
" choosing not to support this (option-')
call HTMLmap("inoremap", "&c,", "&ccedil;")
call HTMLmap("inoremap", "ç", "&ccedil;")
call HTMLmap("inoremap", "&e`", "&egrave;")
call HTMLmap("inoremap", "è", "&egrave;")
call HTMLmap("inoremap", "&e'", "&eacute;")
call HTMLmap("inoremap", "é", "&eacute;")
call HTMLmap("inoremap", "&e^", "&ecirc;")
call HTMLmap("inoremap", "ê", "&ecirc;")
call HTMLmap("inoremap", "&e\"", "&euml;")
call HTMLmap("inoremap", "ë", "&euml;")
call HTMLmap("inoremap", "&i`", "&igrave;")
call HTMLmap("inoremap", "ì", "&igrave;")
call HTMLmap("inoremap", "&i'", "&iacute;")
call HTMLmap("inoremap", "í","&iacute;")
call HTMLmap("inoremap", "&i^", "&icirc;")
call HTMLmap("inoremap", "î", "&icirc;")
call HTMLmap("inoremap", "&i\"", "&iuml;")
call HTMLmap("inoremap", "ï", "&iuml;")
call HTMLmap("inoremap", "&n~", "&ntilde;")
call HTMLmap("inoremap", "ñ", "&ntilde;")
call HTMLmap("inoremap", "&o`", "&ograve;")
call HTMLmap("inoremap", "ò", "&ograve;")
call HTMLmap("inoremap", "&o'", "&oacute;")
call HTMLmap("inoremap", "ó", "&oacute;")
call HTMLmap("inoremap", "&o^", "&ocirc;")
call HTMLmap("inoremap", "ô", "&ocirc;")
call HTMLmap("inoremap", "&o~", "&otilde;")
call HTMLmap("inoremap", "õ", "&otilde;")
call HTMLmap("inoremap", "&o\"", "&ouml;")
call HTMLmap("inoremap", "ö", "&ouml;")
call HTMLmap("inoremap", "&x", "&times;")
" hmmm, need to look at this one
call HTMLmap("inoremap", "&u`", "&ugrave;")
call HTMLmap("inoremap", "ù", "&ugrave;")
call HTMLmap("inoremap", "&u'", "&uacute;")
call HTMLmap("inoremap", "ú", "&uacute;")
call HTMLmap("inoremap", "&u^", "&ucirc;")
call HTMLmap("inoremap", "û", "&ucirc;")
call HTMLmap("inoremap", "&u\"", "&uuml;")
call HTMLmap("inoremap", "ü", "&uuml;")
call HTMLmap("inoremap", "&y'", "&yacute;")
" exists for mac?
call HTMLmap("inoremap", "&y\"", "&yuml;")
call HTMLmap("inoremap", "ÿ", "&yuml;")
...
call HTMLmap("inoremap", "°", "&deg;")
call HTMLmap("inoremap", "&mu", "&micro;")
call HTMLmap("inoremap", "µ", "&micro;")
